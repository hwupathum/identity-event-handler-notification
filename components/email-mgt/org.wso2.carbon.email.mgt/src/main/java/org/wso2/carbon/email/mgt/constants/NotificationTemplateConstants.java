...
public class NotificationTemplateConstants {
    ...
    public static class SqlQueries {
        ...
        public static final String ADD_NOTIFICATION_TEMPLATE = "INSERT INTO IDN_NOTIF_TEMPLATE " +
                "(TEMPLATE_TYPE_ID, LOCALE, CONTENT, CONTENT_TYPE) VALUES (:TEMPLATE_TYPE_ID;, :LOCALE;, " +
                ":CONTENT;, :CONTENT_TYPE;)";
        public static final String UPDATE_NOTIFICATION_TEMPLATE = "UPDATE IDN_NOTIF_TEMPLATE SET CONTENT = :CONTENT;, " +
                "CONTENT_TYPE = :CONTENT_TYPE; WHERE TEMPLATE_TYPE_ID = :TEMPLATE_TYPE_ID; AND LOCALE = :LOCALE;";
        public static final String GET_NOTIFICATION_TEMPLATE_BY_ID = "SELECT TEMPLATE_TYPE_ID, CONTENT, " +
                "CONTENT_TYPE FROM IDN_NOTIF_TEMPLATE WHERE TEMPLATE_TYPE_ID = :TEMPLATE_TYPE_ID; AND LOCALE = :LOCALE;";
        public static final String GET_NOTIFICATION_TEMPLATE = "SELECT TEMPLATE_TYPE_ID, CONTENT, " +
                "CONTENT_TYPE FROM IDN_NOTIF_TEMPLATE WHERE TEMPLATE_TYPE_ID IN (" + GET_NOTIFICATION_TEMPLATE_TYPE_ID +
                ") AND LOCALE = :LOCALE;";
        public static final String GET_NOTIFICATION_TEMPLATES_BY_TYPE = "SELECT TEMPLATE_TYPE_ID, LOCALE, CONTENT, " +
                "CONTENT_TYPE  FROM IDN_NOTIF_TEMPLATE WHERE TEMPLATE_TYPE_ID IN (" + GET_NOTIFICATION_TEMPLATE_TYPE_ID + ")";
        public static final String GET_ALL_NOTIFICATION_TEMPLATES = "SELECT TEMPLATE_TYPE_ID, DISPLAY_NAME, TEMPLATE_TYPE, " +
                "LOCALE, CONTENT, CONTENT_TYPE FROM IDN_NOTIF_TEMPLATE JOIN IDN_NOTIF_TEMPLATE_TYPE " +
